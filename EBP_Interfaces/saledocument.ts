/**
 * Interface pour la table SaleDocument
...
export interface SaleDocument {
  ...
  /** InterestAmountVatExcluded - numeric */
  InterestAmountVatExcluded: number;

  /** InterestRate - numeric */
  InterestRate: number;

  /** HumanServiceTotalAmount - numeric */
  HumanServiceTotalAmount: number;

  /** HumanServiceAmountSettledByOther - numeric */
  HumanServiceAmountSettledByOther: number;

  /** HumanServiceAmountSettledByCESU - numeric */
  HumanServiceAmountSettledByCESU: number;

  /** HumanServiceAmountSettledByCESUP - numeric */
  HumanServiceAmountSettledByCESUP: number;

  /** HumanServiceDeductibleAmount - numeric */
  ...
  /** xx_Date_Report_Attente - timestamp without time zone (nullable) */
  xx_Date_Report_Attente?: Date | string;
  ...
  /** OriginDocumentNumber - text (nullable) */
  ...
  /** ThirdIdToDeliver - text (nullable) */
  ...
  /** xx_Nature_Piece - text (nullable) */
  xx_Nature_Piece?: string;

  /** xx_Type_d_envoi - text (nullable) */
  xx_Type_d_envoi?: string;

  /** xx_Facturation - text (nullable) */
  xx_Facturation?: string;
  ...
  /** CustomerCivility - text (nullable) */
  CustomerCivility?: string;

  /** CustomerIntracommunityVatNumber - text (nullable) */
  ...
  /** xx_Regul_Marge - numeric (nullable) */
  xx_Regul_Marge?: number;

  /** xx_Satisf_Dte_Envoi - timestamp without time zone (nullable) */
  xx_Satisf_Dte_Envoi?: Date | string;

  /** xx_Satisf_Dte_Retour - timestamp without time zone (nullable) */
  xx_Satisf_Dte_Retour?: Date | string;
  ...
  /** xx_CA_Corrige - numeric (nullable) */
  xx_CA_Corrige?: number;

  /** xx_Marge_Corrigee - numeric (nullable) */
  xx_Marge_Corrigee?: number;

  /** xx_SoldeDu_Corrige - numeric (nullable) */
  xx_SoldeDu_Corrige?: number;

  /** xx_Valeur_Rachat - numeric (nullable) */
  xx_Valeur_Rachat?: number;

  /** xx_Regul_CA - numeric (nullable) */
  xx_Regul_CA?: number;

  /** xx_Regul_SoldeDu - numeric (nullable) */
  xx_Regul_SoldeDu?: number;
  ...
  /** DeliveryAddressType - smallint (nullable) */
  ...
  /** DocumentOptionsId - uuid (nullable) */
  DocumentOptionsId?: string;

  /** xx_Mois_Facture - text (nullable) */
  xx_Mois_Facture?: string;
  ...
  /** CustomerHeadOfficeAddressId - uuid (nullable) */
  CustomerHeadOfficeAddressId?: string;

  /** xx_Controlee - boolean */
  xx_Controlee: boolean;

  /** xx_Contrat_de_Maintenance - boolean */
  xx_Contrat_de_Maintenance: boolean;
